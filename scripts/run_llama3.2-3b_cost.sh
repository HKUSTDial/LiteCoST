...
export N_GPUS=4
export BASE_MODEL="./training/models/merged"
...
export LOG_FILE_NAME="training/log/llama3.2-3b_grpo_cost.log"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/data/cost_fin/train.parquet \
    data.val_files=$HOME/data/cost_fin/test.parquet \
    ...
    trainer.experiment_name='llama3.2_3b_instruct' \
